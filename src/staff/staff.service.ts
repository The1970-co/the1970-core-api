...
const PERMISSION_LABEL_TO_KEY: Record<string, string> = {
  ...
  "Bán hàng đa kênh": "menu.omni_inbox",
  "Tin nhắn": "menu.omni_messages",
  "Bình luận": "menu.omni_comments",
  "Livestream": "menu.omni_livestream",
  "Mở nhóm menu Bán hàng đa kênh": "menu.omni_inbox",
  "Mở menu Tin nhắn": "menu.omni_messages",
  "Mở menu Bình luận": "menu.omni_comments",
  "Mở menu Livestream": "menu.omni_livestream",
  "Xem hội thoại / inbox": "omni_inbox.view",
  "Trả lời tin nhắn": "omni_inbox.reply",
  "Gán/chuyển hội thoại cho nhân viên": "omni_inbox.assign",
  "Quản lý tag hội thoại": "omni_inbox.tags.manage",
  "Ghi chú nội bộ hội thoại": "omni_inbox.notes.manage",
  "Tạo đơn từ hội thoại": "omni_inbox.create_order",
  "Đánh dấu/chốt hội thoại": "omni_inbox.close",
  "Xuất dữ liệu hội thoại": "omni_inbox.export",
  "Cấu hình inbox / kết nối kênh": "omni_inbox.settings",
  "Xem bình luận": "omni_comments.view",
  "Trả lời bình luận": "omni_comments.reply",
  "Ẩn/xử lý bình luận": "omni_comments.hide",
  "Xem hội thoại livestream": "omni_livestream.view",
  "Trả lời livestream": "omni_livestream.reply",
...
const ROLE_TEMPLATES: Record<string, BranchPermissionTemplate> = {
  owner: {
    ...
    permissionKeys: [
      ...
      "omni_comments.reply",
      "omni_comments.hide",
      "omni_livestream.view",
      "omni_livestream.reply",
    ],
  },
  admin: {
    canView: true,
