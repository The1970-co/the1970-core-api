...
async function uploadImage(file: Express.Multer.File) {
  ...
  const result: any = await new Promise((resolve, reject) => {
    const stream = cloudinary.uploader.upload_stream(
      { folder: "the1970/production/accessories", resource_type: "image" },
...
export class ProductionController {
  ...
  @RequirePermissions("production.view")
  factories() {
    return this.service.listFactories();
  }

  @Post("factories")
  @RequirePermissions("production.manage")
  createFactory(@Body() body: any) {
    return this.service.createFactory(body);
  }

  @Patch("factories/:id")
  @RequirePermissions("production.manage")
  updateFactory(@Param("id") id: string, @Body() body: any) {
    return this.service.updateFactory(id, body);
  }

  @Delete("factories/:id")
  @RequirePermissions("production.manage")
  deleteFactory(@Param("id") id: string) {
    return this.service.deactivateFactory(id);
  }
  ...
  createSupplier(@Body() body: any) {
    return this.service.createAccessorySupplier(body);
  }

  @Patch("accessory-suppliers/:id")
  @RequirePermissions("accessories.manage")
  updateSupplier(@Param("id") id: string, @Body() body: any) {
    return this.service.updateAccessorySupplier(id, body);
  }

  @Delete("accessory-suppliers/:id")
  @RequirePermissions("accessories.manage")
